...
def create_stats():
    ...
    "Full capacity": [6480, 6480, 6480, 6480, 6480,2160],
...
def calculate_revenue(df_year_dict, stats_dict):
    ...
    df_only_sample = df_year.loc[:, ~((df_year.columns == 'Assay') | (df_year.columns == 'year'))]
...
def calculate_missedrevenue(df_revenue_dict, stats_dict):
    ...
    print(df_revenue)
    df_only_revenue = df_revenue.loc[:, ~((df_revenue.columns == 'Assay') | (df_revenue.columns == 'year') | (df_revenue.columns == 'AssayID'))]
